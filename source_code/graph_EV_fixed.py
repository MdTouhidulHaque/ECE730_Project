...
with open('E:\Fall_24_Courses\ECE_730\Project_ECE730\Results_rev2\EV_Fixed_Winter\EV_0_Percent\Penetration_results_dct_EV_Winter_0_Percent.pkl', 'rb') as file:  # Put actual directory
...
save_directory = "E:\Fall_24_Courses\ECE_730\Project_ECE730\Results_rev2\EV_Fixed_Winter\PV_0_Percent"  # Put actual directory
...
plt.title('Impact of PV Generations on Voltage Profile of Consumers', fontsize = 24, fontweight='bold')
...
plt.text(3.5, 110, 'EV Penetration Level = 0%', fontsize=20, color='green', ha='center')
...
for penetration_level in range(0, 101, 10):  # Adjust the range as needed
    ...
    plt.title(f'Voltage Profile for Each Node of the Distribution System at {penetration_level}% PV & 0% EV Penetration', fontsize=18, fontweight='bold')
    ...
    #plt.show()
    # Save the plot
    plt.savefig(os.path.join(save_directory, f'Voltage_Profile_{penetration_level}_PV_Penetration.pdf'), format='pdf')
    plt.close()
...
for penetration_level in range(0, 101, 10):  # Adjust the range as needed
    ...
    plt.title(f'Utilization Level for Each Distribution Transformer at {penetration_level}% PV & 0% EV Penetration', fontsize=18, fontweight='bold')
    ...
    # Save the plot
    plt.savefig(os.path.join(save_directory, f'LV_Tr_Utilization_Profile_{penetration_level}_PV_Penetration.pdf'), format='pdf')
    plt.close()
    #plt.show()
